...
var DOMAIN = "blog.kfape.cn";
var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME ="开发猿"; //网站名称
var ABOUTID = 462; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'blog.kfape.cn' },
  { id: 2, domain: 'blog.kfape.cn' },
  { id: 3, domain: 'blog.kfape.cn' }
]
 //首页图标导航
